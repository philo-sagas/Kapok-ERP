...
export default function PermissionPage() {
  ...
  const permissionTypeDict = useDictionary('PermissionType')
  ...
  function loadData() {
    ...
    setIsLoading(true)
    fetch('/api/organization/v1/permission?' + args, {
      method: 'GET',
      headers: {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      valueGetter: (params: GridValueGetterParams<Number>) => (
        permissionTypeDict.mapping[params.value]
      )
    },
    {
      field: 'enabled',
    ...
    <>
      ...
      >
        <Breadcrumbs aria-label="breadcrumb" sx={{flexGrow: 1}}>
          ...
          <Typography color="text.primary">权限管理</Typography>
        </Breadcrumbs>
        <Box sx={{flexShrink: 1}}>
          <TextField
            label="关键字"
