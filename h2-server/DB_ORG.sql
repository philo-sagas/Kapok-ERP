...
(
   ...
   createdBy            varchar(50) not null  comment '',
...
(
   ...
   code                 varchar(50) not null  comment '',
   pCode                varchar(250) not null  comment '',
   name                 varchar(50) not null  comment '',
...
(
   ...
   password             char(102) not null  comment '',
   salt                 char(15) not null  comment '',
